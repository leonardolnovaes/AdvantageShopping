const elements = {
    ...
    productLink: (productName) => `p.roboto-regular.ng-binding:contains("${productName}")`,
    ...
    productDetailsCheckout: (productName) => `#userCart > #toolTipCart table > tbody:contains("${productName}")`,
