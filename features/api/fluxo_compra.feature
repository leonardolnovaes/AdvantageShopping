...
Evidencia: "evidencia_busca_produto_api.png" [Link para Evidência](../../docs/screenshots/api/evidencia_busca_produto_api.png)
...
Evidencia: "evidencia_produto_adicionado_api.png" [Link para Evidência](../../docs/screenshots/api/evidencia_produto_adicionado_api.png)
...
Evidencia: "evidencia_validacao_carrinho_api.png" [Link para Evidência](../../docs/screenshots/api/evidencia_validacao_carrinho_api.png)
...
Evidencia: "evidencia_quantidade_atualizada_api.png" [Link para Evidência](../../docs/screenshots/api/evidencia_quantidade_atualizada_api.png)
...
Evidencia: "evidencia_produto_removido_api.png" [Link para Evidência](../../docs/screenshots/api/evidencia_produto_removido_api.png)
