...
Evidencia: "evidencia_busca_produto.png" [Link para Evidência](../../docs/screenshots/web/evidencia_busca_produto.png)
...
Evidencia: "evidencia_produto_adicionado.png" [Link para Evidência](../../docs/screenshots/web/evidencia_produto_adicionado.png)
...
Evidencia: "evidencia_validacao_carrinho.png" [Link para Evidência](../../docs/screenshots/web/evidencia_validacao_carrinho.png)
...
Evidencia: "evidencia_quantidade_atualizada.png" [Link para Evidência](../../docs/screenshots/web/evidencia_quantidade_atualizada.png)
...
Evidencia: "evidencia_produto_removido.png" [Link para Evidência](../../docs/screenshots/web/evidencia_produto_removido.png)